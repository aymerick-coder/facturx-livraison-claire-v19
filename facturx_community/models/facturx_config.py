...
class FacturxConfig(models.Model):
    ...
    # Chorus Pro configuration (chorus_pro_enabled, chorus_pro_client_id,
    # chorus_pro_client_secret, chorus_pro_login, chorus_pro_password,
    # chorus_pro_environment) has been moved to the optional
    # facturx_chorus_pro module.
    ...
    # --- Mini-connecteur Chorus Pro (pont temporaire avant module dedie) ---
